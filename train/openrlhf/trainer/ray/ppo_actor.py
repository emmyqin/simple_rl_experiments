...
from openrlhf.trainer.ppo_utils import Experience, RemoteExperienceMaker, RemoteExperienceMakerBOX, RemoteExperienceMakerPRMBOX, RemoteExperienceMakerORMBOX, RemoteExperienceMakerEnvMultiturn
...
class ActorPPOTrainerEnvMultiturn(PPOTrainer):
    def __init__(
        self,
        *args,
        ...
        **kwargs,
        ...
        self.experience_maker = RemoteExperienceMakerEnvMultiturn(
            self.actor,
            self.critic,
            self.reward_model,
            self.initial_model,
...
@ray.remote(num_gpus=1)
class ActorModelRayActorEnvMultiturn(BasePPORole):
    def init_model_from_pretrained(self, strategy: DeepspeedStrategy, pretrain):
        args = strategy.args
        self._setup_distributed(strategy)
    ...
    def fit(
        ...
        # configure Trainer
        trainer = ActorPPOTrainerEnvMultiturn(
            strategy,
            self.actor,
            critic_model,
            reward_model,
